package com.fonda.intermidatestoryapp.data

import androidx.paging.PagingSource
import androidx.paging.PagingState
import com.fonda.intermidatestoryapp.api.ApiService
...
class StoryPagingSource(private val apiService: ApiService , private val header : String) : PagingSource<Int, ListStoryItem>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ListStoryItem> {
        return try{
            ...
            val responseData = apiService.getAllListStoriesPaging(header,position)
